...
def dashboard():
    ...
    datad = []
    for i in range(1,13):
        month_total_order = Analysis.month_total_order(i)
        if(month_total_order == []):
            datad.append(0)
        else:
            month_exist_order = Analysis.month_exist_order(i)
            datad.append(month_total_order[0][1] - month_exist_order[0][1])
